        ...
        <div className="flex-1 p-6 ml-64">
          <Card className="bg-white shadow-md">
            <CardHeader>
              ...
              <CardDescription>Transactions from customers to customers</CardDescription>
            </CardHeader>
            <CardContent>
...
export const LatestCustomerToCustomer: React.FC = () => {
  const { sharedKey, jwt } = useKeyContext(); // Get sharedKey and jwt from context
  ...
  return (
    <Link href="/Dashboard/customer-to-customer">
